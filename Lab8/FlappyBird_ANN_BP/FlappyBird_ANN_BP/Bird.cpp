...
// 1. X ・coordinate of the front ・most 菟illar・
// 2. Y ・Coordinate of the lower part of the Upper 撤illar・i.e., (0 + height of Upper pillar)
// 3. Y ・Coordinate of the upper part of the Lower 撤illar・
